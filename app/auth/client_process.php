...
try {
    switch ($action) {
        case 'register':
            ...
            $query = "INSERT INTO clientes (nombre, apellido, email, password, cedula, fecha_nacimiento, telefono, pais) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        case 'login':
            ...
            // Obtenemos todos los datos del cliente, incluyendo el estado 'activo'
            ...
            if ($client && password_verify($password, $client['password'])) {
                ...
                // =====================================================================
                // VALIDACIÓN DE SEGURIDAD: VERIFICAR SI LA CUENTA ESTÁ ACTIVA
                // =====================================================================
                if ($client['activo'] == 0) {
                ...
                // Si todo está bien, procedemos con el login
                $_SESSION['client_logged_in'] = true;
                $_SESSION['client_id'] = $client['id'];
                $_SESSION['client_name'] = $client['nombre'];

                // Si venía del checkout, lo redirigimos de vuelta
