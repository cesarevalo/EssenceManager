...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' || !isset($_POST['action'])) {
    header('Location: ../../public/admin/marcas.php');
    exit;
}
...
try {
    switch ($action) {
        case 'create':
            ...
            $stmt->execute();
            $_SESSION['message'] = 'Marca creada exitosamente.';
        ...
        case 'update':
            ...
            $stmt->execute();
            $_SESSION['message'] = 'Marca actualizada exitosamente.';
            $_SESSION['message_type'] = 'success';
            break;
        ...
        case 'delete':
            ...
            $stmt->bindParam(':id', $id);
            $stmt->execute();
            $_SESSION['message'] = 'Marca eliminada exitosamente.';
            $_SESSION['message_type'] = 'success';
            break;
    ...
    if ($e->getCode() == '23000') {
        $_SESSION['message'] = 'Error: No se puede eliminar esta marca porque está siendo utilizada por uno o más productos.';
