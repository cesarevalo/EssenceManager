        ...
        <?php if (isset($_SESSION['client_logged_in']) && $_SESSION['client_logged_in']): ?>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>public/mi_cuenta.php">Mi Cuenta</a></li>
                <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>public/mis_pedidos.php">Mis Pedidos</a></li>
