...
// --- CONSULTA ACTUALIZADA: Ahora trae todos los datos del producto ---
...
// --- (La consulta del historial de compras no cambia) ---
$query = "
    SELECT
        c.id AS id_compra,
        c.fecha_compra,
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php if (empty($historial)): ?>
                            <tr><td colspan="6" class="text-center">Este producto no tiene historial de compras.</td></tr>
                        <?php else: ?>
