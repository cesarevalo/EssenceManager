        ...
        <form id="filter-form">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input filter-change" type="checkbox" name="disponibilidad[]" value="Disponible" id="disp-disponible" checked>
                    <label class="form-check-label" for="disp-disponible">Disponible</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input filter-change" type="checkbox" name="disponibilidad[]" value="Por llegar" id="disp-porllegar" checked>
                    <label class="form-check-label" for="disp-porllegar">Por llegar</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input filter-change" type="checkbox" name="disponibilidad[]" value="Agotado" id="disp-agotado" checked>
                    <label class="form-check-label" for="disp-agotado">Agotado</label>
                </div>
            </div>
            <hr>
